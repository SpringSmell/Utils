...
object SystemActionManager {
     ...
     * @param telNumber 号码
     */
    fun startActionCall(context:Context,telNumber: String) {
        context.applicationContext.startActivity(actionCall(telNumber))
    }
    ...
    fun actionCamera(context:Context,savePath: String): Intent {
