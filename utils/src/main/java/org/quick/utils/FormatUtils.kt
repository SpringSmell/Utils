...
object FormatUtils {
    ...
    fun formatDip2Px(context: Context,dpValue: Float): Float = dpValue * context.applicationContext.resources.displayMetrics.density + 0.5f


    fun formatPx2Dip(context: Context,pxValue: Float): Float = pxValue / context.applicationContext.resources.displayMetrics.density + 0.5F
